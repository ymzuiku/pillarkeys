...
/***/ "./node_modules/roughjs/src/generator.js":
/*!***********************************************!*\
  !*** ./node_modules/roughjs/src/generator.js ***!
  \***********************************************/
/*! exports provided: RoughGenerator, RoughGeneratorAsync */
...
/* harmony import */ var _renderer_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./renderer.js */ "./node_modules/roughjs/src/renderer.js");
    ...
    if (!this._renderer) {
      if (self && self.workly && this.config.async && (!this.config.noWorker)) {
        ...
        if (rendererSource && worklySource) {
          ...
          this._renderer = new _renderer_js__WEBPACK_IMPORTED_MODULE_0__["RoughRenderer"]();
        }
      } else {
        this._renderer = new _renderer_js__WEBPACK_IMPORTED_MODULE_0__["RoughRenderer"]();
      }
...
/***/ "./node_modules/roughjs/src/hachure.js":
/*!*********************************************!*\
  !*** ./node_modules/roughjs/src/hachure.js ***!
  \*********************************************/
/*! exports provided: RoughHachureIterator */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RoughHachureIterator", function() { return RoughHachureIterator; });
/* harmony import */ var _segment__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./segment */ "./node_modules/roughjs/src/segment.js");
...
class RoughHachureIterator {
  constructor(top, bottom, left, right, gap, sinAngle, cosAngle, tanAngle) {
    ...
    if (Math.abs(sinAngle) < 0.0001) {
      ...
      this.sLeft = new _segment__WEBPACK_IMPORTED_MODULE_0__["RoughSegment"](left, bottom, left, top);
      this.sRight = new _segment__WEBPACK_IMPORTED_MODULE_0__["RoughSegment"](right, bottom, right, top);
    }
  }
  ...
  getNextLine() {
    if (Math.abs(this.sinAngle) < 0.0001) {
      ...
      if (this.pos < (this.right + this.deltaX)) {
        ...
        let s = new _segment__WEBPACK_IMPORTED_MODULE_0__["RoughSegment"](xLower, yLower, xUpper, yUpper);
        if (s.compare(this.sLeft) == Object(_segment__WEBPACK_IMPORTED_MODULE_0__["RoughSegmentRelation"])().INTERSECTS) {
          xLower = s.xi;
          yLower = s.yi;
        }
        if (s.compare(this.sRight) == Object(_segment__WEBPACK_IMPORTED_MODULE_0__["RoughSegmentRelation"])().INTERSECTS) {
          xUpper = s.xi;
          yUpper = s.yi;
        }
        if (this.tanAngle > 0) {
...
/***/ "./node_modules/roughjs/src/path.js":
/*!******************************************!*\
  !*** ./node_modules/roughjs/src/path.js ***!
  \******************************************/
...
/***/ "./node_modules/roughjs/src/renderer.js":
/*!**********************************************!*\
  !*** ./node_modules/roughjs/src/renderer.js ***!
  \**********************************************/
...
/* harmony import */ var _hachure_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./hachure.js */ "./node_modules/roughjs/src/hachure.js");
/* harmony import */ var _segment_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./segment.js */ "./node_modules/roughjs/src/segment.js");
/* harmony import */ var _path_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./path.js */ "./node_modules/roughjs/src/path.js");
...
class RoughRenderer {
  ...
  hachureFillShape(xCoords, yCoords, o) {
    ...
    if (xCoords && yCoords && xCoords.length && yCoords.length) {
      ...
      const it = new _hachure_js__WEBPACK_IMPORTED_MODULE_0__["RoughHachureIterator"](top - 1, bottom + 1, left - 1, right + 1, gap, sinAngle, cosAngle, tanAngle);
      let rectCoords;
  ...
  svgPath(path, o) {
    ...
    let p = new _path_js__WEBPACK_IMPORTED_MODULE_2__["RoughPath"](path);
    if (o.simplification) {
      let fitter = new _path_js__WEBPACK_IMPORTED_MODULE_2__["PathFitter"](p.linearPoints, p.closed);
      let d = fitter.fit(o.simplification);
      p = new _path_js__WEBPACK_IMPORTED_MODULE_2__["RoughPath"](d);
    }
    let ops = [];
      ...
      case 'a': {
        ...
        if (seg.data.length >= 7) {
          ...
          if (rx == 0 || ry == 0) {
            ...
            for (let i = 0; i < 1; i++) {
              let arcConverter = new _path_js__WEBPACK_IMPORTED_MODULE_2__["RoughArcConverter"](
                [path.x, path.y],
                [x, y],
                [rx, ry],
                angle,
  ...
  _getIntersectingLines(lineCoords, xCoords, yCoords) {
    let intersections = [];
    var s1 = new _segment_js__WEBPACK_IMPORTED_MODULE_1__["RoughSegment"](lineCoords[0], lineCoords[1], lineCoords[2], lineCoords[3]);
    for (var i = 0; i < xCoords.length; i++) {
      let s2 = new _segment_js__WEBPACK_IMPORTED_MODULE_1__["RoughSegment"](xCoords[i], yCoords[i], xCoords[(i + 1) % xCoords.length], yCoords[(i + 1) % xCoords.length]);
      if (s1.compare(s2) == Object(_segment_js__WEBPACK_IMPORTED_MODULE_1__["RoughSegmentRelation"])().INTERSECTS) {
...
/***/ "./node_modules/roughjs/src/segment.js":
/*!*********************************************!*\
  !*** ./node_modules/roughjs/src/segment.js ***!
  \*********************************************/
/*! exports provided: RoughSegmentRelation, RoughSegment */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RoughSegmentRelation", function() { return RoughSegmentRelation; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RoughSegment", function() { return RoughSegment; });
...
/* harmony import */ var _roughjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./roughjs */ "./src/roughjs.js");



function getPathFromLayer(layer) {
  var nsbezierpath = NSBezierPath.bezierPathWithPath(layer.sketchObject.pathInFrameWithTransforms());
  return String(nsbezierpath.svgPathAttribute()).replace(/^d="/g, '').replace(/"$/g, '');
}

function getOptionsFromLayer(layer) {
  var options = {};
  var fill = (layer.style.fills || []).filter(function (f) {
    return f.sketchObject.isEnabled() && f.fill === 'Color';
  })[0];
  ...
  var border = (layer.style.borders || []).filter(function (f) {
    return f.sketchObject.isEnabled() && f.fillType === 'Color';
  })[0];
...
/* harmony default export */ __webpack_exports__["default"] = (function (context) {
  ...
  selection.forEach(function (layer) {
    ...
    var rc = new _roughjs__WEBPACK_IMPORTED_MODULE_1__["RoughSketch"](layer.parent);
    var newLayer = rc.path(getPathFromLayer(layer), getOptionsFromLayer(layer));
    newLayer.name = 'Rough ' + layer.name; // add new layer to parent

    newLayer.parent = layer.parent; // hide previous layer

    layer.hidden = true;
    layer.selected = false; // select new one
...
/*!************************!*\
  !*** ./src/roughjs.js ***!
  \************************/
/*! exports provided: RoughSketch */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RoughSketch", function() { return RoughSketch; });
/* harmony import */ var roughjs_src_generator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! roughjs/src/generator */ "./node_modules/roughjs/src/generator.js");
...
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }
 ...
 // we hook into the internals to write the wrapper ourselves


var RoughSketch =
/*#__PURE__*/
function () {
  function RoughSketch(layer, config) {
    _classCallCheck(this, RoughSketch);

    this.layer = sketch__WEBPACK_IMPORTED_MODULE_1___default.a.fromNative(layer);
  ...
  _createClass(RoughSketch, [{
    ...
    value: function _init(config) {
      this.gen = new roughjs_src_generator__WEBPACK_IMPORTED_MODULE_0__["RoughGenerator"](config, this.layer.frame);
    }
  }, {
    key: "line",
    ...
    value: function draw(drawable) {
      ...
      var o = drawable.options || this.gen.defaultOptions; // create a group where we will put everything inside

      var group = new sketch__WEBPACK_IMPORTED_MODULE_1___default.a.Group({
        frame: {
          x: 0,
          y: 0,
      ...
      try {
        for (var _iterator = sets[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          ...
          switch (drawing.type) {
            case 'path':
              {
                ...
                path = sketch__WEBPACK_IMPORTED_MODULE_1___default.a.Shape.fromNative(MSShapeGroup.shapeWithBezierPath(MSPath.pathWithBezierPath(SVGPathInterpreter.bezierPathFromCommands_isPathClosed(this._opsToPath(drawing), closed))));
                path.style.borders = [{
                  color: o.stroke,
            ...
            case 'fillPath':
              {
                var _closed = MOPointer.alloc().init();

                path = sketch__WEBPACK_IMPORTED_MODULE_1___default.a.Shape.fromNative(MSShapeGroup.shapeWithBezierPath(MSPath.pathWithBezierPath(SVGPathInterpreter.bezierPathFromCommands_isPathClosed(this._opsToPath(drawing), _closed))));
                path.style.borders = [];
            ...
            case 'path2Dfill':
              {
                var _closed2 = MOPointer.alloc().init();

                path = sketch__WEBPACK_IMPORTED_MODULE_1___default.a.Shape.fromNative(MSShapeGroup.shapeWithBezierPath(MSPath.pathWithBezierPath(SVGPathInterpreter.bezierPathFromCommands_isPathClosed(drawing.path, _closed2))));
                path.style.borders = [];
                path.style.fills = [o.fill];
                path.parent = group;
                break;
            ...
            case 'path2Dpattern':
              {
                ...
                path = new sketch__WEBPACK_IMPORTED_MODULE_1___default.a.Group({
                  frame: {
                    x: 0,
                    y: 0,
                    width: this.layer.frame.width,
                ...
                var _closed3 = MOPointer.alloc().init();

                var mask = sketch__WEBPACK_IMPORTED_MODULE_1___default.a.Shape.fromNative(MSShapeGroup.shapeWithBezierPath(MSPath.pathWithBezierPath(SVGPathInterpreter.bezierPathFromCommands_isPathClosed(drawing.path, _closed3))));
                mask.style.borders = [];
                mask.style.fills = [];
                mask.parent = path;

                var hash = this._fillSketch(drawing, o);
    ...
    value: function _fillSketch(drawing, o) {
      ...
      var closed = MOPointer.alloc().init();
      var path = sketch__WEBPACK_IMPORTED_MODULE_1___default.a.Shape.fromNative(MSShapeGroup.shapeWithBezierPath(MSPath.pathWithBezierPath(SVGPathInterpreter.bezierPathFromCommands_isPathClosed(this._opsToPath(drawing), closed))));
      path.style.borders = [{
        color: o.fill,
        thickness: fweight
      }];
